...
(epa_per_play_plot <- df_team_epa %>% 
  ...
  geom_richtext(aes(x = .2, y = .2, label = "Good O, Bad D"), size = 2.75, fontface = 'bold', color = 'black', fill = "#f7f7f7") +
  geom_richtext(aes(x = -.2, y = -.2, label = "Bad O, Good D"), size = 2.75, fontface = 'bold', color = 'black', fill = "#f7f7f7") +
  geom_richtext(aes(x = -.2, y = .2, label = "Bad O, Bad D"), size = 2.75, fontface = 'bold', color = 'white',  fill = "#762a83", label.colour = 'black') +
  geom_richtext(aes(x = .195, y = -.2, label = "Good O, Good D"), size = 2.75, fontface = 'bold', color = 'white', fill = "#1b7837", label.colour = 'black') +
...
(defensive_epa_runpass <-  run_pass_def_epa %>% 
  ...
  # annotate("rect", xmin = off_epa_min, xmax = (off_epa_max + off_epa_min) / 2,
  #          ymin = def_epa_min, ymax = (def_epa_max + def_epa_min) / 2, fill= "#f7f7f7", alpha = .5, color = 'transparent') +
  geom_richtext(aes(x = .2, y = .2, label = "Bad P, Bad R"), size = 2.75, fontface = 'bold', color = 'white', fill = "#762a83") +
  geom_richtext(aes(x = -.2, y = -.2, label = "Good P, Good R"), size = 2.75, fontface = 'bold', color = 'white', fill = "#1b7837") +
  geom_richtext(aes(x = -.2, y = .2, label = "Good R, Bad P"), size = 2.75, fontface = 'bold', color = 'black',  fill = "#f7f7f7", label.colour = 'black') +
  geom_richtext(aes(x = .195, y = -.2, label = "Good P, Bad R"), size = 2.75, fontface = 'bold', color = 'black', fill = "#f7f7f7", label.colour = 'black') +
  # note: I've been using geom_image(), but this appears to not have a transparent background which geom_nfl_logos() offers
