...
<!-- rnb-frame-begin  -->

<div data-pagedtable="false">
  <script data-pagedtable-source type="application/json">
{"columns":[{"label":["posteam"],"name":[1],"type":["chr"],"align":["left"]},{"label":["success_rate_pass"],"name":[2],"type":["dbl"],"align":["right"]},{"label":["success_rate_run"],"name":[3],"type":["dbl"],"align":["right"]},{"label":["avg_epa_pass"],"name":[4],"type":["dbl"],"align":["right"]},{"label":["avg_epa_run"],"name":[5],"type":["dbl"],"align":["right"]}],"data":[{"1":"NYJ","2":"56.5","3":"48.7","4":"0.47","5":"0.06"},{"1":"PIT","2":"44.1","3":"36.8","4":"0.30","5":"-0.11"}],"options":{"columns":{"min":{},"max":[10],"total":[5]},"rows":{"min":[10],"max":[10],"total":[2]},"pages":{}}}
  </script>
</div>
